            ...
            <div class="card-body">
              <form role="form text-left" method="POST" action="/register">
                ...
                <div class="mb-3">
                  ...
                  <div class="mb-3">
                    <input type="date" class="form-control" placeholder="Date Of Birth" name="dob" id="dob" aria-label="Date Of Birth" aria-describedby="dob" value="{{ old('dob') }}">
                    @error('dob')
                      <p class="text-danger text-xs mt-2">{{ $message }}</p>
                    @enderror
                  </div>
                ...
                <div class="mb-3">
                    <input type="text" class="form-control" placeholder="Address" name="address" id="address" aria-label="Address" aria-describedby="address" value="{{ old('address') }}">
                    @error('address')
                      <p class="text-danger text-xs mt-2">{{ $message }}</p>
                    @enderror
                  </div>
                  <div class="mb-3">
                    <input type="text" class="form-control" placeholder="Contact Number" name="phone" id="phone" aria-label="Contact Number" aria-describedby="phone" value="{{ old('phone') }}">
                    @error('phone')
                      <p class="text-danger text-xs mt-2">{{ $message }}</p>
                    @enderror
                  </div>
                ...
                <div class="form-check form-check-info ">
                    <input class="form-check-input" type="radio" id="sponsor" name="role" value="Sponsor">
                    <label class="form-check-label" for="flexCheckDefault">
                     I'm a Sponsor.
                    </label>
                  </div>
