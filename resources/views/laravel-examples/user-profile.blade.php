                ...
                <form action="/user-profile" method="POST" role="form text-left">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.first_name')border border-danger rounded-3 @enderror">
                                    <input class="form-control" value="{{ auth()->user()->first_name }}" type="text" placeholder="First Name" id="first_name" name="first_name">
                                        @error('first_name')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('last_name')border border-danger rounded-3 @enderror">
                                    <input class="form-control" value="{{ auth()->user()->last_name }}" type="text" placeholder="Last Name" id="last_name" name="last_name">
                                        @error('last_name')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.dob')border border-danger rounded-3 @enderror">
                                    <input class="form-control" value="{{ auth()->user()->dob }}" type="date" placeholder="Date Of Birth" id="dob" name="dob">
                                        @error('dob')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                </div>
                        ...
                        {{-- <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.role') border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="text" placeholder="Role" id="role" name="role"  value="{{ auth()->user()->role }}">
                                </div>
                            </div>
                        </div> --}}
                    </div>
                    <div class="form-group">
                        ...
                        <div class="@error('user.address')border border-danger rounded-3 @enderror">
                            <textarea class="form-control" id="address" rows="3" placeholder="Address" name="address">{{ auth()->user()->address }}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
